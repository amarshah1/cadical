...
def process_results(results):
    output_dir = "results_gbc_csvs_short"
...
def run_clause_lengths():
    ...
    clauses_dir = f"garbage_global_clauses_short/"

    os.makedirs(clauses_dir, exist_ok=True)

    # Select .cnf files
    files = [f for f in os.listdir(input_dir)][:5]
    ...
    csv_filename = "useful_clauses_short.csv"
