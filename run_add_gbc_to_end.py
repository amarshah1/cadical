...
for file_name in file_names:
    ...
    for i in range(num_shuffles):
        file_path = f"results/{file_name_without_cnf}/{file_name_without_cnf}_scramble{i}/"
        global_clauses_file_path = os.path.join(file_path, "global_clauses/", file_name_without_cnf + f"_{i}.global_clauses.txt")
