...
print("STARTING RUN_QUERIES_WITH_GBC")

def process_file(file_name, results_directory):
    ...
    print(f"We are looking at {input_dir}{file_name}")
    ...
    print("We have finished on file ", file_name)
    ...
    return {"sat_results": sat_results, "unsat_results": unsat_results, "error_results": error_results, "timeout_results": timeout_results}

def process_results(results):
    output_dir = "results_original_csvs"
...
def run_clause_lengths():
    ...
    clauses_dir = f"garbage_global_clauses2/"
